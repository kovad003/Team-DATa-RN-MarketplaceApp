...
export const POSTEDITEMS = [
  ...
  new PostedItem('cr153', 'c4' , 'p017' , 'Nike shoes', '18' , 'Limited edition Nike shoes', 'new', '20.09.2021',  "https://images.unsplash.com/photo-1524532787116-e70228437bbe?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80"),
  new PostedItem('hs434', 'c1' , 'p005' , 'Sofa', '70' , 'blue leather sofa - barely used', 'very new', '15.09.2021',  "https://images.unsplash.com/photo-1582582494705-f8ce0b0c24f0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=869&q=80"),
  new PostedItem('it965', 'c5' , 'p005' , 'Play station 3', '120' , 'Play station 3 slim with two controller', 'Old', '06.09.2021',  "https://images.unsplash.com/photo-1526509867162-5b0c0d1b4b33?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"),
  new PostedItem('kl341', 'c7' , 'p011' , 'Coocking Pan', '5' , '28 cm Cooking pan - brand Teffal', 'new', '06.08.2021',  "https://images.unsplash.com/photo-1592156328757-ae2941276b2c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"),
